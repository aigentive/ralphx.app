...
export const AGENT_ORCHESTRATOR_IDEATION = "ralphx-ideation" as const;
export const AGENT_QA_PREP = "qa-prep" as const;
export const AGENT_QA_EXECUTOR = "qa-executor" as const;
export const AGENT_CHAT_TASK = "ralphx-chat-task" as const;
export const AGENT_CHAT_PROJECT = "ralphx-chat-project" as const;
export const AGENT_REVIEW_CHAT = "review-chat" as const;
export const AGENT_SESSION_NAMER = "ralphx-utility-session-namer" as const;
