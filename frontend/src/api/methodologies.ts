/**
 * Methodologies API Module
 *
 * Provides a centralized API wrapper for methodology operations.
 * This module mirrors src/lib/api/methodologies.ts but follows the
 * domain API pattern used by projects.ts and other centralized modules.
 */
...
// ============================================================================
// Methodologies API Object
// ============================================================================

/**
 * Methodologies API object containing all typed Tauri command wrappers
 */
