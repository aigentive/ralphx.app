...
export function AgentsSidebar({
  ...
  return (
    <aside
      className="w-[300px] min-w-[260px] max-w-[320px] h-full flex flex-col border-r overflow-hidden"
      style={{
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                onClick={onQuickCreateAgent}
                disabled={isCreatingAgent || projects.length === 0}
                aria-label="Quick agent"
                data-testid="agents-quick-create"
              >
        ...
        <div className="mt-1 ml-4 space-y-0.5">
          {sortedConversations.map((conversation) => {
            ...
            return (
              ...
              >
                {isActiveRuntime && agentStatus !== "idle" ? (
                  <Circle
