...
export declare const TOOL_CATEGORIES: {
    ...
    readonly ideation: readonly ["v1_start_ideation", "v1_get_ideation_status", "v1_send_ideation_message", "v1_list_proposals", "v1_get_proposal_detail", "v1_get_plan", "v1_accept_plan_and_schedule", "v1_modify_proposal", "v1_analyze_dependencies"];
