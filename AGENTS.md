...
| P1 | Settings surface | YAML-seeded execution allocation defaults now land only on pristine rows; next add the UI/API controls for global/project ideation caps + borrow toggle |
