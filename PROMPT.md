...
| Task Size | Improvement |
|-----------|-------------|
| Small (<50 LOC) | Single lint/type fix |
| Medium (50-150 LOC) | Extract helper, fix error handling |
| Large (>150 LOC) | Refactor pattern, extract module |

**Process:**
1. Launch **Explore agent** → scan codebase for issues
2. Pick **ONE** fix (type safety, naming, dead code, lint, error handling)
3. Execute fix
