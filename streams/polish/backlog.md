...
- [ ] ~~Implement TODO: Open diff viewer - src/App.tsx:784~~ (PRD:20:1:1:1:1)
- [ ] ~~Implement TODO: Edit task modal - src/components/tasks/TaskFullView.tsx:213~~ (PRD:18:1:1:1:1)
...
- [ ] ~~[P3] [Frontend] Remove console.log stub from event handler~~ (stale:1 - no console.log present at line 263)
...
- [ ] [P3] [Frontend] Replace promise chain .then() with async/await - src/hooks/useStepEvents.ts:82
...
**Completed:** 10
**Validated:** 14 strikethroughs (2026-01-28 x2) - 4 archived, 1 reactivated, 9 incremented
