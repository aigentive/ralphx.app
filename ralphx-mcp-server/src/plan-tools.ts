...
export const PLAN_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Update an existing implementation plan's content. Use when the user provides feedback, clarifications, or decisions that need to be incorporated into the plan. Creates a new version of the artifact.",
    inputSchema: {
      type: "object",
      properties: {
        artifact_id: {
        ...
        content: {
          type: "string",
          description:
            "Updated plan content in markdown format. This will create a new version of the artifact.",
        },
      },
  ...
  },
  {
    ...
    description:
      "Retrieve a plan artifact's current content. Use when you need to reference the plan details during conversation or when creating proposals.",
    inputSchema: {
      type: "object",
      properties: {
        artifact_id: {
  ...
  },
  {
    ...
    description:
      "Link multiple task proposals to an implementation plan. Use after creating proposals to establish the connection between the plan and its derived tasks. This enables traceability and allows the system to suggest updates when the plan changes.",
    inputSchema: {
      type: "object",
      properties: {
        proposal_ids: {
