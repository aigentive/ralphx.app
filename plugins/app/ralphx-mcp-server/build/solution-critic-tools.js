export const SOLUTION_CRITIC_TOOLS = [
    {
        ...
        inputSchema: {
            ...
            properties: {
                session_id: {
                    type: "string",
                    description: "Optional ideation session ID. Verifier-owned calls should omit this.",
                },
                target_artifact_id: {
                    type: "string",
    ...
    },
    {
        ...
        description: "Read a persisted CompiledContext artifact for the current ideation plan scope. For verifier-owned runs, omit session_id.",
        inputSchema: {
            type: "object",
            properties: {
                session_id: {
    ...
    },
    {
        ...
        description: "Read a persisted SolutionCritique artifact plus its backend-projected verification gaps for the current ideation plan scope. For verifier-owned runs, omit session_id.",
        inputSchema: {
            type: "object",
            properties: {
                session_id: {
...
//# sourceMappingURL=solution-critic-tools.js.map