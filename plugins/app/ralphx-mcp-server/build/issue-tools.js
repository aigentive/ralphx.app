...
export const ISSUE_TOOLS = [
    {
        ...
        description: "Fetch review issues for a task. Returns structured issues from prior reviews with severity, status, file path, and line number. " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                status_filter: {
                    type: "string",
                    enum: ["open", "all"],
                    description: "Filter issues by status: 'open' for unresolved only, 'all' for everything (default: 'all')",
                },
            },
            required: ["task_id"],
        },
    },
    {
        ...
        description: "Get a summary of issue resolution progress for a task. Returns counts of open, in_progress, and addressed issues. " +
    ...
    },
    {
        ...
        description: "Mark a review issue as in-progress. Call this BEFORE starting to fix an issue to track progress. " +
    ...
    },
    {
        ...
        description: "Mark a review issue as addressed. Call this AFTER fixing an issue to indicate it has been resolved. " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                resolution_notes: {
                    type: "string",
                    description: "Description of how the issue was resolved (e.g., 'Fixed null check in validateInput()')",
                },
                attempt_number: {
                    type: "number",
