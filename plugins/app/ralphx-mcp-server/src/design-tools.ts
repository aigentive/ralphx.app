...
const CURRENT_DESIGN_CONTEXT_DESCRIPTION =
  "Optional design system id. Defaults to the current RalphX design chat context.";

export const DESIGN_TOOLS: Tool[] = [
  {
    name: "get_design_system",
    description:
      "Read the current design system summary, selected source projects, and linked design conversation.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
  ...
  },
  {
    ...
    description:
      "Read the backend-validated source manifest for the current design system, including selected source scopes and recorded hashes.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
  ...
  },
  {
    ...
    description:
      "Set the review status for one styleguide item in the current design system.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
  ...
  },
  {
    ...
    description:
      "Record explicit user feedback for one styleguide item in Design state without adding another chat message.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
        ...
        conversation_id: {
          type: "string",
          description:
            "Optional design conversation id. Defaults to the active design conversation.",
        },
      },
  ...
  },
  {
    ...
    description:
      "Generate a RalphX-owned, reviewable screen or component design artifact from the current design schema without writing to source projects.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
        ...
        artifact_kind: {
          ...
          description:
            "Design artifact kind to generate. Screen artifacts should use compact workspace preview patterns; component artifacts should use realistic state previews.",
        },
        name: {
          type: "string",
        ...
        brief: {
          type: "string",
          description:
            "Optional concise intent or constraints. Include the row pattern, expected preview states, and any source-backed caveats the renderer should preserve.",
        },
        source_item_id: {
          type: "string",
          description:
            "Optional styleguide item id to ground the artifact and preview pattern. Defaults to a matching screen or component row.",
        },
      },
  ...
  },
  {
    ...
    description:
      "List current schema, source-audit, styleguide, and run-output artifacts for the current design system without exposing storage paths.",
    inputSchema: {
      type: "object",
      properties: {
        design_system_id: {
