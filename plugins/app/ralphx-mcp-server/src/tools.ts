...
export const ALL_TOOLS: Tool[] = [
  ...
  // ========================================================================
  {
    ...
    description:
      "Submit a critic result for a verification round. Atomically creates a team artifact and inserts a " +
  ...
  },
  {
    ...
    description:
      "Retrieve all critic results for a (parent_session_id, generation, round) triple. " +
