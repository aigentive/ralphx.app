...
| `ralphx-plugin/ralphx-mcp-server/src/tools.ts` | Server-side MCP tool filtering (TOOL_ALLOWLIST) |
| `ralphx-plugin/agents/*.md` | Agent system prompts with frontmatter allowlists |
