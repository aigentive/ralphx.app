...
|----------|----------|---------|
| Claude Code Agent Teams | `docs/ai-docs/claude-code/agent-teams.md` | Official-doc stub for agent teams behavior |
| Claude Code Subagents | `docs/ai-docs/claude-code/sub-agents.md` | Official-doc stub for subagent configuration |
| Claude Code Hooks | `docs/ai-docs/claude-code/hooks.md` | Official-doc stub for hook reference |
| Claude Code CLI | `docs/ai-docs/claude-code/cli-reference.md` | Official-doc stub for CLI flags and commands |
| RalphX Spawning System | `docs/architecture/claude-spawning-system.md` | Full CLI spawning pipeline |
| Claude Code Settings | `docs/ai-docs/claude-code/settings.md` | Official-doc stub for configuration scopes |
| Claude Code Plugins | `docs/ai-docs/claude-code/plugins.md` | Official-doc stub for plugin system |
