...
export function isArtifactContextTool(name: string): boolean {
  // get_artifact, get_artifact_version, get_plan_artifact are handled by ArtifactWidget
  // get_task_context is handled by ContextWidget
  return ["get_related_artifacts", "search_project_artifacts"].includes(name);
