...
import type { ToolWidgetProps } from "./registry";
...
function CompleteReviewCard({ toolCall, className = "", compact = false }: ToolWidgetProps) {
...
function GetReviewNotesCard({ toolCall, className = "", compact = false }: ToolWidgetProps) {
  const [isExpanded, setIsExpanded] = useState(false);
...
export const ReviewWidget = React.memo(function ReviewWidget(props: ToolWidgetProps) {
...
registerWidget(["complete_review", "get_review_notes"], ReviewWidget);
