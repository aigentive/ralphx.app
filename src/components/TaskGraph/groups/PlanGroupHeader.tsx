...
export const PlanGroupHeader = memo(function PlanGroupHeader({
  ...
  if (isCollapsed) {
    return (
      <div
        className="flex flex-col gap-1 px-3 py-1.5 bg-[hsl(var(--bg-elevated)/0.8)] rounded-lg cursor-pointer"
  ...
  return (
    <div
      className="flex items-center justify-between gap-3 px-3 py-1.5 bg-[hsl(var(--bg-elevated)/0.8)] rounded-t-lg cursor-pointer"
      onDoubleClick={onToggleCollapse}
    >
      {/* Left: toggle + title */}
