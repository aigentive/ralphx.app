/**
 * Tauri API wrappers for artifact operations
 *
 * Provides type-safe functions for artifact, bucket, and relation CRUD with Zod validation.
 */
 ...
 */
export async function getArtifact(id: string): Promise<ArtifactResponse | null> {
 ...
 * @returns Array of artifact responses
 */
export async function getArtifactsByBucket(
  bucketId: string
): Promise<ArtifactResponse[]> {
 ...
 * @returns Array of artifact responses
 */
export async function getArtifactsByTask(
  taskId: string
): Promise<ArtifactResponse[]> {
 ...
 */
export async function getBuckets(): Promise<BucketResponse[]> {
 ...
 * @throws ZodError if input validation fails
 */
export async function createBucket(input: CreateBucketInput): Promise<BucketResponse> {
  // Validate input before sending
 ...
 */
export async function getSystemBuckets(): Promise<BucketResponse[]> {
 ...
 * @throws ZodError if input validation fails
 */
export async function addArtifactRelation(
  input: AddRelationInput
): Promise<ArtifactRelationResponse> {
  // Validate input before sending
 ...
 */
export async function getArtifactRelations(
  artifactId: string
): Promise<ArtifactRelationResponse[]> {
