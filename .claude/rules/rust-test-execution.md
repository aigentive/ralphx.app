...
| Runtime-config determinism | Integration tests must not assume ambient `ralphx.yaml`, cached runtime config, or entity defaults for behavioral setup; set or neutralize the precondition explicitly in suite helpers/builders |
