...
| Low-dependency workspace crate | `src-tauri/crates/ralphx-domain` holds pure `agents`, `qa`, `execution`, `ideation`, and most `entities` including memory/team types; test it directly when you touch those areas |
