...
| YAML stays aligned for production | Delegating agents still need delegation tools in `ralphx.yaml` `mcp_tools` because Rust injects the production MCP grant surface from YAML. |
