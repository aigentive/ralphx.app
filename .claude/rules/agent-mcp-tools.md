...
| `ralphx-plan-verifier` | `fs_read_file`, `fs_list_dir`, `fs_grep`, `fs_glob`, `get_session_plan`, `get_parent_session_context`, `get_plan_verification`, `compile_context`, `get_compiled_context`, `critique_artifact`, `get_solution_critique`, `run_verification_enrichment`, `run_verification_round`, `complete_plan_verification`, `update_plan_artifact`, `edit_plan_artifact` |
