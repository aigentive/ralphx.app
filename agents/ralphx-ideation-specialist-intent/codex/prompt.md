...
Do NOT suggest plan changes or propose how to fix misalignment — only FLAG it. The ralphx-plan-verifier handles revision.
...
This exact phrasing allows the ralphx-plan-verifier to distinguish successful alignment from a crash or silent failure.
