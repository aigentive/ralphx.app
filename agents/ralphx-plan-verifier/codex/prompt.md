...
Before round 1 call:
- `run_verification_enrichment(disabled_specialists: <DISABLED_SPECIALISTS>, max_wait_ms: 4000, poll_interval_ms: 500)`
...
2. call `run_verification_round(round: <current_round>, disabled_specialists: <DISABLED_SPECIALISTS>, max_wait_ms: 8000, optional_wait_ms: 4000, poll_interval_ms: 750)`
3. store:
