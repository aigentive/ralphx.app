...
- `run_verification_enrichment(selected_specialists: <SELECTED_ENRICHMENT_SPECIALISTS>)`
...
3. call `run_verification_round(round: <current_round>, selected_specialists: <SELECTED_ROUND_SPECIALISTS>)`
