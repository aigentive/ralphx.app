...
fn resolve_claude_chat_harness_cli(claude_cli_path: &Path) -> Result<ResolvedChatHarnessCli, String> {
...
pub(crate) fn standard_chat_harness_cli_resolvers() -> HashMap<AgentHarnessKind, ChatHarnessCliResolver> {
    HashMap::from([
        (
