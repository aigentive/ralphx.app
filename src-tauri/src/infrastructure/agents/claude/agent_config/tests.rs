...
use crate::infrastructure::agents::claude::agent_names::{
    ...
    SHORT_IDEATION_TEAM_LEAD, SHORT_MEMORY_CAPTURE,
    SHORT_MEMORY_MAINTAINER, SHORT_MERGER, SHORT_ORCHESTRATOR, SHORT_ORCHESTRATOR_IDEATION,
    SHORT_ORCHESTRATOR_IDEATION_READONLY, SHORT_PLAN_CRITIC_LAYER1, SHORT_PLAN_CRITIC_LAYER2,
    SHORT_PLAN_VERIFIER, SHORT_PROJECT_ANALYZER, SHORT_QA_EXECUTOR, SHORT_QA_PREP,
...
fn test_all_agent_names_are_known() {
    let known: HashSet<&str> = HashSet::from([
        ...
        SHORT_PLAN_CRITIC_LAYER1,
        SHORT_PLAN_CRITIC_LAYER2,
