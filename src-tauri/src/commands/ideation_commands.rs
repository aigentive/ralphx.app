...
/// Note: This struct is intentionally identical to context_chat_commands::ChatMessageResponse
/// to ensure consistent API responses across all chat-related endpoints.
#[derive(Debug, Serialize)]
