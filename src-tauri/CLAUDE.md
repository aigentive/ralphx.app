...
| Workspace domain split | Low-dependency backend modules and pure entities move into `src-tauri/crates/ralphx-domain`; keep Tauri/SQLite-facing or root-coupled code in the root crate until a clean boundary exists |
