...
| Test determinism | Integration tests must not rely on ambient `ralphx.yaml`, cached runtime config, or entity defaults for behavioral preconditions; set or neutralize the precondition explicitly in the fixture/helper |
