...
fn test_empty_project_returns_zero_stats() {
    ...
    let stats = compute_project_stats(&conn, "proj1").expect("compute_project_stats");
...
fn test_stats_scoped_to_project() {
    ...
    let s1 = compute_project_stats(&conn, "proj1").expect("proj1");
    let s2 = compute_project_stats(&conn, "proj2").expect("proj2");
...
fn test_weekly_throughput_counts_merged_tasks_in_current_week() {
    ...
    let trends = compute_project_trends(&conn, "proj1").expect("compute_project_trends");
...
fn test_weekly_throughput_scoped_to_project() {
    ...
    let t1 = compute_project_trends(&conn, "proj1").expect("proj1 trends");
    let t2 = compute_project_trends(&conn, "proj2").expect("proj2 trends");
