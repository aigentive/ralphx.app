...
[
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of Kanban board with tasks",
      "Verify against Acceptance Criteria in specs/design/pages/kanban-board.md",
      "Verify against Design Quality Checklist in specs/design/pages/kanban-board.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of two-panel layout",
      "Verify against Acceptance Criteria in specs/design/pages/ideation-view.md",
      "Verify against Design Quality Checklist in specs/design/pages/ideation-view.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of settings page",
      "Verify against Acceptance Criteria in specs/design/pages/settings-view.md",
      "Verify against Design Quality Checklist in specs/design/pages/settings-view.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of activity stream",
      "Verify against Acceptance Criteria in specs/design/pages/activity-stream.md",
      "Verify against Design Quality Checklist in specs/design/pages/activity-stream.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshots of each tab (Workflows, Artifacts, Research, Methodologies)",
      "Verify against Acceptance Criteria in specs/design/pages/extensibility-view.md",
      "Verify against Design Quality Checklist in specs/design/pages/extensibility-view.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of modal",
      "Verify against Acceptance Criteria in specs/design/pages/task-detail.md",
      "Verify against Design Quality Checklist in specs/design/pages/task-detail.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Open Reviews panel",
      "Use agent-browser to capture screenshot of panel",
      "Verify against Acceptance Criteria in specs/design/pages/reviews-panel.md",
      "Verify against Design Quality Checklist in specs/design/pages/reviews-panel.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Open Chat panel (Cmd+K)",
      "Use agent-browser to capture screenshot of chat panel",
      "Verify against Acceptance Criteria in specs/design/pages/chat-panel.md",
      "Verify against Design Quality Checklist in specs/design/pages/chat-panel.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Navigate to a task with QA data, open Task Detail",
      "Use agent-browser to capture screenshots of QA components",
      "Verify against Acceptance Criteria in specs/design/pages/qa-components.md",
      "Verify against Design Quality Checklist in specs/design/pages/qa-components.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Use agent-browser to capture screenshot showing sidebar",
      "Verify against Acceptance Criteria in specs/design/pages/project-sidebar.md",
      "Verify against Design Quality Checklist in specs/design/pages/project-sidebar.md",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Use agent-browser to capture screenshot of ProjectCreationWizard",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Open Diff Viewer (from task or merge dialog)",
      "Use agent-browser to capture screenshot",
      "Verify against Acceptance Criteria in specs/design/pages/diff-viewer.md",
      "Verify against Design Quality Checklist in specs/design/pages/diff-viewer.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Use agent-browser to capture screenshot of bottom control bar",
      "Verify against Acceptance Criteria in specs/design/pages/execution-control-bar.md",
      "Verify against Design Quality Checklist in specs/design/pages/execution-control-bar.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Use agent-browser to capture screenshot of header",
      "Verify against Acceptance Criteria in specs/design/pages/header-navigation.md",
      "Verify against Design Quality Checklist in specs/design/pages/header-navigation.md",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Open each modal and capture screenshots:",
  ...
  },
  {
    ...
    "steps": [
      "Ensure npm run tauri dev is running",
      "Use agent-browser to capture comprehensive screenshot set:",
